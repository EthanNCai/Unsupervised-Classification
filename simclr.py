...
def main():
    ...
    # python simclr.py
    # --config_env configs/your_env.yml
    ...
    """
    retrieve dataset
    1.get the transformation group(aka. augmentation group)
    2.apply the transformation group to the original dataset
    3.get a dataloader obj
    """
